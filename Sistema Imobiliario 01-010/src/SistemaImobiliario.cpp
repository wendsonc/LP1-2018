...
void SistemaImobiliario::removerPorBairro(){
  ...
  //  SistemaImobiliario::salvarTerreno();
...
void SistemaImobiliario::removerPorCidade(){
    ...
    listaAp.erase(listaAp.begin()+cont1);
    ...
    listaTerreno.erase(listaTerreno.begin()+cont2);
