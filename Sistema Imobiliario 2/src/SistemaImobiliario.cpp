...
void SistemaImobiliario::removerCasa(){
    ...
    listaCasa.erase(remove_if(listaCasa.begin(),
                              listaCasa.end(),
                              [](Casa novaCasa){return novaCasa.getTam() == novaCasa.getNumPavimentos();}),
                    listaCasa.end());

    listaAp.erase(remove_if(listaAp.begin(),
                              listaAp.end(),
                              [](Apartamento novoAp){return novoAp.getTipoOferta() == novoAp.getVagasGaragem();}),
                    listaAp.end());

    listaTerreno.erase(remove_if(listaTerreno.begin(),
                              listaTerreno.end(),
                              [](Terreno novoTerreno){return novoTerreno.getArea() == novoTerreno.getValor();}),
                    listaTerreno.end());
