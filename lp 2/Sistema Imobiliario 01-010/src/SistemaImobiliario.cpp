...
void SistemaImobiliario::editarPorBairro(){
    ...
    if(op1 == 1){
        ...
        listaCasa.insert(listaCasa.begin()+cont, novaCasa);
    }

}

void SistemaImobiliario::editarPorCidade(){
...
void SistemaImobiliario::editarPorTitulo(){
...
void SistemaImobiliario::editarPorValorMaior(){
...
void SistemaImobiliario::editarPorValorMenor(){
